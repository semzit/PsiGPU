...
__global__ void toffoli_kernel(cuDoubleComplex* state_vector, int num_qubits, int target_qubit, int control_qubit); 
...
__global__ void hadamard_kernal(cuDoubleComplex* state_vector, int num_qubits, int target_qubit); 
